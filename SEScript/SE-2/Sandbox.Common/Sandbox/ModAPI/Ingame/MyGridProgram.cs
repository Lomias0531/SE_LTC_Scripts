...
namespace Sandbox.ModAPI.Ingame
{
	...
	public abstract class MyGridProgram : IMyGridProgram
	{
		...
		public virtual IMyIntergridCommunicationSystem IGC => m_IGC_ContextGetter();
		...
		protected MyGridProgram()
		{
			...
			if (method != null)
			{
				m_main = method.CreateDelegate<Action<string, UpdateType>>(this);
			}
			else
			{
			...
			if (method2 != null)
			{
				m_save = method2.CreateDelegate<Action>(this);
			}
		}
