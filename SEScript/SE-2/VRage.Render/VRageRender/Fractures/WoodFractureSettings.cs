...
namespace VRageRender.Fractures
{
	public class WoodFractureSettings : MyFractureSettings
	{
		...
		[Category("Splinter")]
		[Browsable(false)]
		public Vector3 SplinterSplittingAxis
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public Rotation SplinterRotateSplitGeom
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public int SplinterNumSubparts
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterWidthRange
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		[Browsable(false)]
		public Vector3 SplinterScaleRange
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterSplitGeomShiftRangeY
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterSplitGeomShiftRangeZ
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterSurfaceNormalShearingRange
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterFractureLineShearingRange
		{
			get;
			set;
		}
		...
		[Category("Splinter")]
		public float SplinterFractureNormalShearingRange
		{
			get;
			set;
		}
		...
		public string SplinterSplittingPlane
		{
			get;
			set;
		}
		...
		[Category("Board")]
		[Browsable(false)]
		public Vector3 BoardSplittingAxis
		{
			get;
			set;
		}
		...
		[Description("Rotate Split Geometry")]
		[Category("Board")]
		public Rotation BoardRotateSplitGeom
		{
			get;
			set;
		}
		...
		[Category("Board")]
		[Browsable(false)]
		public Vector3 BoardScaleRange
		{
			get;
			set;
		}
		...
		[Description("Splitting geometry Y shift range")]
		[Category("Board")]
		public float BoardSplitGeomShiftRangeY
		{
			get;
			set;
		}
		...
		[Description("Splitting geometry Z shift range")]
		[Category("Board")]
		public float BoardSplitGeomShiftRangeZ
		{
			get;
			set;
		}
		...
		[Description("Surface normal shearing range")]
		[Category("Board")]
		public float BoardSurfaceNormalShearingRange
		{
			get;
			set;
		}
		...
		[Description("Fracture line shearing range")]
		[Category("Board")]
		public float BoardFractureLineShearingRange
		{
			get;
			set;
		}
		...
		[Description("Fracture normal shearing range")]
		[Category("Board")]
		public float BoardFractureNormalShearingRange
		{
			get;
			set;
		}
		...
		[Category("Board")]
		[Editor("Telerik.WinControls.UI.PropertyGridBrowseEditor, Telerik.WinControls.UI", "Telerik.WinControls.UI.BaseInputEditor, Telerik.WinControls.UI")]
		public string BoardSplittingPlane
		{
			get;
			set;
		}
