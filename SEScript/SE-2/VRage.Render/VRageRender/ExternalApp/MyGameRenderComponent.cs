...
namespace VRageRender.ExternalApp
{
	...
	{
		public MyRenderThread RenderThread
		{
			get;
			private set;
		}
		...
		public void StartSync(MyGameTimer timer, IVRageWindow window, MyRenderDeviceSettings? settings, MyRenderQualityEnum renderQuality, float maxFrameRate)
		{
