...
namespace VRage.Game
{
	...
	public class MyObjectBuilder_RadialMenuItemCubeBlock : MyObjectBuilder_RadialMenuItem
	{
		...
		protected class VRage_Game_MyObjectBuilder_RadialMenuItemCubeBlock_003C_003EIcon_003C_003EAccessor : VRage_Game_MyObjectBuilder_RadialMenuItem_003C_003EIcon_003C_003EAccessor, IMemberAccessor<MyObjectBuilder_RadialMenuItemCubeBlock, string>
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Set(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, in string value)
			{
				Set(ref *(MyObjectBuilder_RadialMenuItem*)(&owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Get(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, out string value)
			{
				Get(ref *(MyObjectBuilder_RadialMenuItem*)(&owner), out value);
			}
		}

		protected class VRage_Game_MyObjectBuilder_RadialMenuItemCubeBlock_003C_003ELabel_003C_003EAccessor : VRage_Game_MyObjectBuilder_RadialMenuItem_003C_003ELabel_003C_003EAccessor, IMemberAccessor<MyObjectBuilder_RadialMenuItemCubeBlock, MyStringId>
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Set(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, in MyStringId value)
			{
				Set(ref *(MyObjectBuilder_RadialMenuItem*)(&owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Get(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, out MyStringId value)
			{
				Get(ref *(MyObjectBuilder_RadialMenuItem*)(&owner), out value);
			}
		}
		...
		{
			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Set(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, in MyStringHash value)
			{
				Set(ref *(MyObjectBuilder_Base*)(&owner), in value);
			}

			[MethodImpl(MethodImplOptions.AggressiveInlining)]
			public unsafe sealed override void Get(ref MyObjectBuilder_RadialMenuItemCubeBlock owner, out MyStringHash value)
			{
