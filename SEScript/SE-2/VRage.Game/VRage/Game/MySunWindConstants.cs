...
namespace VRage.Game
{
	public static class MySunWindConstants
	{
		...
		public const float SWITCH_LARGE_AND_SMALL_BILLBOARD_DISTANCE_HALF = 3333.33325f;

		public static readonly float FORCE_ANGLE_RANDOM_VARIATION_IN_RADIANS = MathHelper.ToRadians(70f);
