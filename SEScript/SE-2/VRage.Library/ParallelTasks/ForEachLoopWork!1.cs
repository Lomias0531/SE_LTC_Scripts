namespace ParallelTasks
{
    ...
    internal class ForEachLoopWork<T> : AbstractWork, IPrioritizedWork, IWork
    {
        ...
        {
            base.FillDebugInfo(ref info, this.action.get_Method().Name, MyProfiler.TaskType.WorkItem);
        }
        ...
        {
            private sealed ForEachLoopWork<T> CreateInstance() => 
                new ForEachLoopWork<T>();
