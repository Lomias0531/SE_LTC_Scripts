...
namespace Sandbox.Engine.Utils
{
	public static class MyFakes
	{
		...
		public static bool ENABLE_SOUND_OCCLUSION;
		...
		public static bool ENABLE_MISSION_TRIGGERS;
		...
		public static bool ENABLE_DEBUG_DRAW_GENERATING_BLOCK;
		...
		public static bool ENABLE_ATMOSPHERIC_ENTRYEFFECT;
		...
		public static bool SHOW_BANNERS;

		public static bool ENABLE_NGEN;

		public static bool ENABLE_RESAVE_PROTOBUFFERS;
		...
		public static bool ENABLE_TESTING_TOOL_HEPER;
		...
		public static readonly bool OWN_ALL_DLCS;

		public static readonly bool OWN_ALL_ITEMS;
		...
		public static bool IsExperimentalAllowed;
		...
		static MyFakes()
		{
			...
			GAME_SAVES_COMPRESSED_BY_DEFAULT = false;
			...
			ENABLE_BEHAVIOR_TREE_TOOL_COMMUNICATION = true;
			...
			ENABLE_DEBUG_DRAW_GENERATING_BLOCK = false;
			...
			ENABLE_ANSEL_WITH_SPRITES = true;
			...
			SHOW_BANNERS = false;
			ENABLE_NGEN = true;
			ENABLE_RESAVE_PROTOBUFFERS = false;
			...
			ENABLE_TESTING_TOOL_HEPER = true;
			ENABLE_ANIMATED_KINEMATIC_UPDATE = true;
			ENABLE_GRID_PLACEMENT_TEST = true;
			EXIT_URL = null;
			PUBLIC_BETA_MP_TEST = !string.IsNullOrEmpty(EXIT_URL);
			USE_GOODBOT_DEV_SERVER = PUBLIC_BETA_MP_TEST;
			...
			SWITCH_DLC_FROM = 0u;
			SWITCH_DLC_TO = 0u;
			LIMITED_MAIN_MENU = false;
			ENABLE_GDPR_MESSAGE = true;
			ENABLE_ASTEROIDS = true;
			DEFAULT_PROCEDURAL_ASTEROID_GENERATOR = 4;
			IsModdingAllowed = true;
			IsExperimentalAllowed = true;
			LOBBY_MAX_PLAYERS = 8;
			...
			PREFER_ONLINE = false;
			ENABLE_SIMPLE_NEWGAME_SCREEN = false;
