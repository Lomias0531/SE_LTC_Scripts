namespace VRage.Generics.StateMachine
{
    ...
    public class MyCondition<T> : IMyCondition where T: struct
    {
        ...
        public bool Evaluate()
        {
            ...
            {
                if (!this.m_storage.GetValue(this.m_leftSideStorage, out T leftSideValue))
                {
                    return false;
                }
            }
            ...
            {
                if (!this.m_storage.GetValue(this.m_rightSideStorage, out T rightSideValue))
                {
                    return false;
                }
            }
            ...
            int num = Comparer<T>.get_Default().Compare(leftSideValue, rightSideValue);
