namespace VRage.Utils
{
    ...
    public class MyDiscreteSampler<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public MyDiscreteSampler(Dictionary<T, float> densities) : this((IEnumerable<T>) densities.get_Keys(), (IEnumerable<float>) densities.get_Values())
        {
        }
        ...
        public IEnumerator<T> GetEnumerator() => 
            Enumerable.AsEnumerable<T>(this.m_values).GetEnumerator();
