namespace VRage
{
    ...
    public abstract class MyXmlSerializerBase<TAbstractBase> : IMyXmlSerializable, IXmlSerializable
    {
        ...
        {
            MyXmlSerializerBase<TAbstractBase>.ReaderPool.AllocateOrCreate(out CustomRootReader reader2);
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            MyXmlSerializerBase<TAbstractBase>.WriterPool.AllocateOrCreate(out CustomRootWriter writer2);
            writer2.Init(serializedName, writer);
